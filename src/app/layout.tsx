                ...
                <header className="fixed w-full flex h-16 shrink-0 items-center gap-2 bg-color1">
                  <div className="flex items-center gap-2 ml-3">
                    ...
                    <Separator
                      ...
                      className="mr-2 h-4 bg-color5"
                    />
                    {breadcrumb}
                  </div>
                </header>
                <div className="mt-16 bg-color5 rounded-3xl h-[calc(100vh-80px)] max-h-[calc(100vh-80px)] overflow-y-auto md:mr-4 md:scrollbar-auto scrollbar-hidden">
                  {" "}
                  {children}{" "}
                </div>
                <Toaster richColors />
